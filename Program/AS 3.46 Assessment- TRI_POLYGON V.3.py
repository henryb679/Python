...
'''
- boundary cases for strName and users answer for questions
- changed the widths of the entry boxes of the strName and question Answer inputs to better reflect to
  user that thats the desired character box size   
- creation of userErrorMessage label to inform the user why their input would not proceed
- changed the userFeedback labels to better inform to the user what question they got correct or not through self.intCounter
- changes the titleText font to include bold to help title stand out and subHeading to italic
'''
